...
author: "MZM <br> Milosz, Zeyne, Marco"
...
hpi_2016 <- read_excel("/cloud/project/hpi_2016_data.xlsx") %>% 
  clean_names()
hpi_2017 <- read_excel("/cloud/project/hpi_2017_data.xlsx") %>% 
  clean_names()
hpi_2018 <- read_excel("/cloud/project/hpi_2018_data.xlsx") %>% 
  clean_names()
hpi_2019 <- read_excel("/cloud/project/hpi_2019_data.xlsx") %>% 
  clean_names()
hpi_2020 <- read_excel("/cloud/project/hpi_2020_data.xlsx") %>% 
  clean_names()
```
